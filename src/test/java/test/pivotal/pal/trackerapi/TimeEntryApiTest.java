...
public class TimeEntryApiTest {
    ...
    public void setUp() throws Exception {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/tracker_dev?user=root&password=1234&useSSL=false&useTimezone=true&serverTimezone=UTC&useLegacyDatetimeCode=false");
